...
function bars(id) {
  ...
  function _impl(context) {
    ...
    let formatTime = null;
    if (labelTime != null) {
      let locale = formatLocale$1(time$1(language).d3);
    ...
    let ran = random$1(presentation10$1.standard.slice().reverse());
      ...
      function _makeFillFn() {
        ...
        if (fill == null) {
          if (twoD) {
            ...
            let rnd = random$1(presentation10$1.standard);
            colors = (d, i) => rnd(i);          
          } else {
            colors = () => presentation10$1.standard[0];
          }
        } else if (fill === 'series') {
          let rnd = random$1(presentation10$1.standard);
          colors = (d, i) => rnd(i);
